package net.lianbian.tpc.bankcommon.domain;

import net.lianbian.tpc.bankcommon.service.*;
...
import net.lianbian.tpc.protocol.service.TransactionRepository;
        ...
        try {
            transactionTemplate.execute(new TransactionCallbackWithoutResult() {
                ...
                protected void doInTransactionWithoutResult(TransactionStatus transactionStatus) {
                    ...
                    getParticipantLogKeeper().recordMsg(transaction, net.lianbian.tpc.protocol.domian.TransactionStatus.Yes);
                }
            });
            ...
            try {
                getParticipantLogKeeper().recordMsg(transaction, net.lianbian.tpc.protocol.domian.TransactionStatus.Abort);
            } catch (Exception e2) {
    ...
    public void commit(DistributedTransaction transaction) {
        transactionTemplate.execute(new TransactionCallbackWithoutResult() {
            ...
            protected void doInTransactionWithoutResult(TransactionStatus status) {
                getParticipantLogKeeper().recordMsg(transaction, net.lianbian.tpc.protocol.domian.TransactionStatus.Commit);
